...
<TouchableOpacity style={{backgroundColor:"#28a745",width:Display.setWidth(75),borderRadius:10,marginTop:20}}>
  <Text style={{color:'white',marginVertical:18,textAlign:'center',fontFamily:FONTS.FontRobotoBold,fontSize:17}}>Start Trip</Text>
</TouchableOpacity>
  </View>
    </SafeAreaProvider>
  )
